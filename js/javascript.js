function enviarinfo(v) {
  ...
  if (nombre == "HenryUp") {
    ...
    (tellocal.length < 10 && tellocal.length > 0) ||
    (cellocal.length < 10 && cellocal.length > 0) ||
    celcontacto.length < 10
  ) {
    Swal.fire({
      icon: "error",
      title: "Oops...",
    ...
    if (v == 1) {
      name =
        "Hola Henry! Te envío mis datos de registro:%0A" +
      ...
      setTimeout(
        window.open,
        2000,
        "https://api.whatsapp.com/send?phone=5491164224270&text=" + name,
        "_blank"
      );
    } else if (v == 2) {
      name =
        "Hola Mica! Te envío mis datos de registro:%0A" +
        today.toLocaleString() +
        "%0A%0A" +
        "*Razón social:* " +
        razonsocial +
      ...
      setTimeout(
        window.open,
        2000,
        "https://api.whatsapp.com/send?phone=5492612336233&text=" + name,
        "_blank"
      );
    } else if (v == 3) {
      name =
        "Hola Rolando! Te envío mis datos de registro:%0A" +
        today.toLocaleString() +
        "%0A%0A" +
        "*Razón social:* " +
        razonsocial +
      ...
      setTimeout(
        window.open,
        2000,
        "https://api.whatsapp.com/send?phone=5491164758318&text=" + name,
        "_blank"
      );
    } else if (v == 4) {
      name =
        "Hola Rafa! Te envío mis datos de registro:%0A" +
        today.toLocaleString() +
        "%0A%0A" +
        "*Razón social:* " +
        razonsocial +
      ...
      setTimeout(
        window.open,
        2000,
        "https://api.whatsapp.com/send?phone=5491130630712&text=" + name,
        "_blank"
      );
    } else if (v == 5) {
      name =
        "Hola Tomás! Te envío mis datos de registro:%0A" +
        today.toLocaleString() +
        "%0A%0A" +
        "*Razón social:* " +
        razonsocial +
      ...
      setTimeout(
        window.open,
        2000,
        "https://api.whatsapp.com/send?phone=5493516140055&text=" + name,
        "_blank"
      );
    } else if (v == 6) {
      name =
        "Hola José! Te envío mis datos de registro:%0A" +
        today.toLocaleString() +
        "%0A%0A" +
        "*Razón social:* " +
        razonsocial +
      ...
      setTimeout(
        window.open,
        2000,
        "https://api.whatsapp.com/send?phone=54911&text=" + name,
        "_blank"
      );
    } else if (v == 7) {
      name =
        "Hola Juani! Te envío mis datos de registro:%0A" +
        today.toLocaleString() +
        "%0A%0A" +
        "*Razón social:* " +
        razonsocial +
      ...
      setTimeout(
        window.open,
        2000,
        "https://api.whatsapp.com/send?phone=5491125598524&text=" + name,
        "_blank"
      );
    } else {
      name =
        "Hola! Te envio mis datos de registro:%0A" +
        today.toLocaleString() +
        "%0A%0A" +
        "*Razón social:* " +
        razonsocial +
      ...
      window.open(
        "https://api.whatsapp.com/send?phone=5492235419261&text=" + name,
        "_blank"
      );
    }
  }
